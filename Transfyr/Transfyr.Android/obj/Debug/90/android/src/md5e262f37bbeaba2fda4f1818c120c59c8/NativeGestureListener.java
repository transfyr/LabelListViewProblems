...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FormsGestures.Droid.NativeGestureListener, FormsGestures.Droid", NativeGestureListener.class, __md_methods);
	}


	public NativeGestureListener ()
	{
		super ();
		if (getClass () == NativeGestureListener.class)
			mono.android.TypeManager.Activate ("FormsGestures.Droid.NativeGestureListener, FormsGestures.Droid", "", this, new java.lang.Object[] {  });
	}
